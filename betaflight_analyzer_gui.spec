...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'app.analyzers.step_response_analyzer',
        'app.analyzers.motor_health_analyzer',
        'app.analyzers.tpa_analyzer',
        'app.analyzers.prop_wash_analyzer',
        'app.analyzers.dynamic_idle_analyzer',
        'app.analyzers.anti_gravity_analyzer',
        'app.analyzers.iterm_buildup_analyzer',
        'app.analyzers.feedforward_analyzer',
        'app.analyzers.thrust_linearization_analyzer',
        'app.analyzers.stick_movement_analyzer',
        'app.analyzers.throttle_axis_analyzer',
        'app.analyzers.pid_contribution_analyzer',
        'app.analyzers.master_multiplier',
